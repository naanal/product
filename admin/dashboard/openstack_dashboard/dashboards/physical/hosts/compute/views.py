...
from openstack_dashboard.dashboards.physical.hosts.compute \
    import forms as project_forms


class EvacuateHostView(forms.ModalFormView):
    form_class = project_forms.EvacuateHostForm
    template_name = 'physical/hosts/compute/evacuate_host.html'
    context_object_name = 'compute_host'
    success_url = reverse_lazy("horizon:physical/hosts:index")
    ...
    def get_active_compute_hosts_names(self, *args, **kwargs):
        try:
            ...
            redirect = reverse("horizon:physical/hosts:index")
...
class DisableServiceView(forms.ModalFormView):
    ...
    template_name = 'physical/hosts/compute/disable_service.html'
    context_object_name = 'compute_host'
    success_url = reverse_lazy("horizon:physical/hosts:index")
...
class MigrateHostView(forms.ModalFormView):
        ...
        template_name = 'physical/hosts/compute/migrate_host.html'
        context_object_name = 'compute_host'
        success_url = reverse_lazy("horizon:physical/hosts:index")
