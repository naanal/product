...
(function () {
  ...
  angular
    ...
    .factory('createGroupsModel', createGroupsModel);

  createGroupsModel.$inject = [
    '$q',
    '$log',
    '$rootScope',
  ...
  function createGroupsModel(
    ...
    function createGroups() {
      ...
      console.log(model.singleUser.group_name);
      console.log(model.newUserSpec);
      model.newUserSpec.group_name=[model.singleUser.group_name]
      console.log(model.newUserSpec);
      ...
      function successMessage(response) {
          ...
          $rootScope.$emit("callretieveuserDefineGroups", {});
