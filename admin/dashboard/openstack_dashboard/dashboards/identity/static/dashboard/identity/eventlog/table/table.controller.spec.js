...
(function() {
  ...
  describe('Identity eventlog table controller', function() {
    ...
    beforeEach(module('horizon.dashboard.identity.eventlog'));
    ...
    function createController() {
      return controller('identityeventlogTableController', {
        toast: toastService,
        policyAPI: policyAPI,
