...
(function () {
  ...
  angular
    ...
    .factory('horizon.dashboard.identity.workflow.security-users.workflow', securityUsersWorkflow);

  securityUsersWorkflow.$inject = [
    'horizon.dashboard.identity.workflow.security-users.basePath',
    'horizon.app.core.workflow.factory'
  ];

  function securityUsersWorkflow(basePath, dashboardWorkflow) {    
