...
(function () {
  ...
  angular
    ...
    .factory('securityUsersModel', securityUsersModel);

  securityUsersModel.$inject = [
    '$q',
    '$log',
    '$rootScope',
  ...
  function securityUsersModel(
    ...
    /**
     * @ngdoc method
     * @name securityUsersModel.initialize
     * @returns {promise}
     *
     * @description
