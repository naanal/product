...
(function () {
  ...
  angular
    .module('horizon.dashboard.virtual.workflow.launch-instance', [])
    .config(config)
    .constant('horizon.dashboard.virtual.workflow.launch-instance.modal-spec', {
      backdrop: 'static',
      size: 'lg',
    ...
    /**
     * @name horizon.dashboard.virtual.workflow.launch-instance.boot-source-types
     * @description Boot source types
     */
    .constant('horizon.dashboard.virtual.workflow.launch-instance.boot-source-types', {
      IMAGE: 'image',
      INSTANCE_SNAPSHOT: 'snapshot',
      VOLUME: 'volume',
      VOLUME_SNAPSHOT: 'volume_snapshot'
    })
    .constant('horizon.dashboard.virtual.workflow.launch-instance.non_bootable_image_types',
      ['aki', 'ari'])

    /**
     * @name horizon.dashboard.virtual.workflow.launch-instance.step-policy
     * @description Policies for displaying steps in the workflow.
     */
    .constant('horizon.dashboard.virtual.workflow.launch-instance.step-policy', {
  ...
  function config($provide, $windowProvider) {
    var path = $windowProvider.$get().STATIC_URL + 'dashboard/virtual/workflow/launch-instance/';
    $provide.constant('horizon.dashboard.virtual.workflow.launch-instance.basePath', path);
  }
