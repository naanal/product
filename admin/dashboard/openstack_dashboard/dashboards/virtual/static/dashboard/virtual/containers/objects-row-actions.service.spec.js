...
(function() {
  ...
  describe('horizon.dashboard.virtual.containers objects row actions', function test() {
    beforeEach(module('horizon.app.core.openstack-service-api'));
    beforeEach(module('horizon.framework'));
    beforeEach(module('horizon.dashboard.virtual'));
    beforeEach(module(function before($provide) {
      $provide.constant('horizon.dashboard.virtual.containers.basePath', '/base/path/');
    }));

    var rowActions, $rootScope, model;

    beforeEach(inject(function inject($injector, _$rootScope_) {
      rowActions = $injector.get('horizon.dashboard.virtual.containers.objects-row-actions');
      model = $injector.get('horizon.dashboard.virtual.containers.containers-model');
    ...
    describe('viewService', function test() {
      ...
      beforeEach(inject(function inject($injector, _$modal_, _$q_) {
        ...
        viewService = $injector.get('horizon.dashboard.virtual.containers.objects-actions.view');
        $modal = _$modal_;
        $q = _$q_;
      }));
