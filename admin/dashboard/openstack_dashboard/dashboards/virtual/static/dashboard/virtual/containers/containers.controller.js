...
(function () {
   ...
   * @ngdoc controller
   *
   * @name horizon.dashboard.virtual.containers.ContainersController
   *
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.virtual.containers.ContainersController', ContainersController);
  ...
  ContainersController.$inject = [
    ...
    'horizon.dashboard.virtual.containers.baseRoute',
