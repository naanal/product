...
(function() {
  ...
  angular
    .module('horizon.dashboard.virtual.containers')
    .factory('horizon.dashboard.virtual.containers.objects-row-actions', rowActions)
    .factory('horizon.dashboard.virtual.containers.objects-actions.delete', deleteService)
    .factory('horizon.dashboard.virtual.containers.objects-actions.download', downloadService)
    .factory('horizon.dashboard.virtual.containers.objects-actions.view', viewService);

  rowActions.$inject = [
    'horizon.dashboard.virtual.containers.basePath',
    'horizon.dashboard.virtual.containers.objects-actions.delete',
    'horizon.dashboard.virtual.containers.objects-actions.download',
    'horizon.dashboard.virtual.containers.objects-actions.view',
  ...
  viewService.$inject = [
    ...
    'horizon.dashboard.virtual.containers.basePath',
    'horizon.dashboard.virtual.containers.containers-model',
    'horizon.framework.util.q.extensions',
    '$modal'
  ];
