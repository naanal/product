...
(function () {
   ...
   * @ngdoc controller
   *
   * @name horizon.dashboard.virtual.containers.ObjectsController
   *
   * @description
  ...
  angular
    ...
    .controller('horizon.dashboard.virtual.containers.ObjectsController', ObjectsController);
  ...
  ObjectsController.$inject = [
    ...
    'horizon.dashboard.virtual.containers.containerRoute',
    'horizon.dashboard.virtual.containers.basePath',
    'horizon.dashboard.virtual.containers.objects-row-actions',
