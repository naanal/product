...
(function() {
  ...
  /**
   * @ngdoc virtualevirtualmachineTableController
   * @ngController
   *
   * @description
   ...
   */
  angular
    .module('horizon.dashboard.virtual.virtual_machines')
    .controller('virtualevirtualmachineTableController', virtualevirtualmachineTableController);

  virtualevirtualmachineTableController.$inject = [
  ...
  function virtualevirtualmachineTableController(toast, gettext,novaAPI,Spinner, $scope, $rootScope) {
