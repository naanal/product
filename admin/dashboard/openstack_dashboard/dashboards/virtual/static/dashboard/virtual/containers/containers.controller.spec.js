...
(function() {
  ...
  describe('horizon.dashboard.virtual.containers containers controller', function() {
    ...
    beforeEach(module('horizon.dashboard.virtual.containers', function($provide) {
      $provide.value('horizon.dashboard.virtual.containers.containers-model', fakeModel);
    }));
    ...
    function createController() {
      return controller(
        'horizon.dashboard.virtual.containers.ContainersController', {
          'horizon.dashboard.virtual.containers.baseRoute': 'base ham',
          'horizon.dashboard.virtual.containers.containerRoute': 'eggs '
        });
    }
