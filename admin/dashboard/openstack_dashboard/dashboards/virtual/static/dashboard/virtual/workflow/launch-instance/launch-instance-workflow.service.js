...
(function () {
  ...
  angular
    ...
    .factory('horizon.dashboard.virtual.workflow.launch-instance.workflow', launchInstanceWorkflow);

  launchInstanceWorkflow.$inject = [
    'horizon.dashboard.virtual.workflow.launch-instance.basePath',
    'horizon.dashboard.virtual.workflow.launch-instance.step-policy',
