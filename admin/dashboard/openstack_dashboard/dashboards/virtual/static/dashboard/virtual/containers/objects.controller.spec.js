...
(function() {
  ...
  describe('horizon.dashboard.virtual.containers objects controller', function() {
    ...
    beforeEach(module(function before($provide) {
      ...
      $provide.constant('horizon.dashboard.virtual.containers.containerRoute', 'eggs/');
    }));
    ...
    function createController(folder) {
      ...
      return controller(
        'horizon.dashboard.virtual.containers.ObjectsController',
        {$scope: $scope}
      );
    }
