...
INDEX_URL = "horizon:virtual:volumes:index"


class CreateView(workflows.WorkflowView):
    workflow_class = vol_cgroup_workflows.CreateCGroupWorkflow
    template_name = 'virtual/volumes/cgroups/create.html'
    page_title = _("Create Volume Consistency Group")


class UpdateView(forms.ModalFormView):
    template_name = 'virtual/volumes/cgroups/update.html'
    ...
    submit_url = "horizon:virtual:volumes:cgroups:update"
