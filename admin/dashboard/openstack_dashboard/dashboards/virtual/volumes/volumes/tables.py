...
class LaunchVolume(tables.LinkAction):
    ...
    url = "horizon:virtual:instances:launch"
...
class LaunchVolumeNG(LaunchVolume):
    ...
    verbose_name = _("Launch as Instance")
    url = "horizon:virtual:volumes:index"
    classes = ("btn-launch", )
    ajax = False
...
class CreateVolume(tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:create"
...
class ExtendVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:extend"
...
class EditAttachments(tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:attach"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateSnapshot(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:create_snapshot"
    classes = ("ajax-modal",)
    icon = "camera"
...
class CreateTransfer(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:create_transfer"
    classes = ("ajax-modal",)
...
class CreateBackup(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:create_backup"
    classes = ("ajax-modal",)
...
class UploadToImage(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:upload_to_image"
    classes = ("ajax-modal",)
    icon = "cloud-upload"
...
class EditVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class RetypeVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:retype"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class AcceptTransfer(tables.LinkAction):
    ...
    url = "horizon:virtual:volumes:volumes:accept_transfer"
    classes = ("ajax-modal",)
    icon = "exchange"
...
def get_attachment_name(request, attachment):
    ...
    try:
        url = reverse("horizon:virtual:instances:detail", args=(server_id,))
...
class VolumesTableBase(tables.DataTable):
    ...
    name = tables.Column("name",
                         verbose_name=_("Name"),
                         link="horizon:virtual:volumes:volumes:detail")
