...
from openstack_dashboard.dashboards.virtual.volumes \
    .volumes import forms as virtual_forms

from openstack_dashboard.dashboards.virtual.volumes \
    .volumes import tables as virtual_tables
from openstack_dashboard.dashboards.virtual.volumes \
    .volumes import tabs as virtual_tabs


class DetailView(tabs.TabView):
    tab_group_class = virtual_tabs.VolumeDetailTabs
    ...
    def get_context_data(self, **kwargs):
        ...
        table = virtual_tables.VolumesTable(self.request)
        context["volume"] = volume
        context["url"] = self.get_redirect_url()
        context["actions"] = table.render_row_actions(volume)
        choices = virtual_tables.VolumesTableBase.STATUS_DISPLAY_CHOICES
    ...
    def get_redirect_url(self):
        return reverse('horizon:virtual:volumes:index')
...
class CreateView(forms.ModalFormView):
    form_class = virtual_forms.CreateForm
    modal_header = _("Create Volume")
    template_name = 'virtual/volumes/volumes/create.html'
    submit_label = _("Create Volume")
    submit_url = reverse_lazy("horizon:virtual:volumes:volumes:create")
    success_url = reverse_lazy('horizon:virtual:volumes:volumes_tab')
...
class ExtendView(forms.ModalFormView):
    form_class = virtual_forms.ExtendForm
    modal_header = _("Extend Volume")
    template_name = 'virtual/volumes/volumes/extend.html'
    submit_label = _("Extend Volume")
    submit_url = "horizon:virtual:volumes:volumes:extend"
    success_url = reverse_lazy("horizon:virtual:volumes:index")
...
class CreateSnapshotView(forms.ModalFormView):
    form_class = virtual_forms.CreateSnapshotForm
    modal_header = _("Create Volume Snapshot")
    template_name = 'virtual/volumes/volumes/create_snapshot.html'
    submit_url = "horizon:virtual:volumes:volumes:create_snapshot"
    success_url = reverse_lazy('horizon:virtual:volumes:snapshots_tab')
...
class UploadToImageView(forms.ModalFormView):
    form_class = virtual_forms.UploadToImageForm
    modal_header = _("Upload Volume to Image")
    template_name = 'virtual/volumes/volumes/upload_to_image.html'
    submit_label = _("Upload")
    submit_url = "horizon:virtual:volumes:volumes:upload_to_image"
    success_url = reverse_lazy("horizon:virtual:volumes:index")
...
class CreateTransferView(forms.ModalFormView):
    form_class = virtual_forms.CreateTransferForm
    template_name = 'virtual/volumes/volumes/create_transfer.html'
    success_url = reverse_lazy('horizon:virtual:volumes:volumes_tab')
    modal_id = "create_volume_transfer_modal"
    modal_header = _("Create Volume Transfer")
    submit_label = _("Create Volume Transfer")
    submit_url = "horizon:virtual:volumes:volumes:create_transfer"
...
class AcceptTransferView(forms.ModalFormView):
    form_class = virtual_forms.AcceptTransferForm
    template_name = 'virtual/volumes/volumes/accept_transfer.html'
    success_url = reverse_lazy('horizon:virtual:volumes:volumes_tab')
    modal_id = "accept_volume_transfer_modal"
    modal_header = _("Accept Volume Transfer")
    submit_label = _("Accept Volume Transfer")
    submit_url = reverse_lazy(
        "horizon:virtual:volumes:volumes:accept_transfer")
    page_title = _("Accept Volume Transfer")


class ShowTransferView(forms.ModalFormView):
    form_class = virtual_forms.ShowTransferForm
    template_name = 'virtual/volumes/volumes/show_transfer.html'
    success_url = reverse_lazy('horizon:virtual:volumes:volumes_tab')
    modal_id = "show_volume_transfer_modal"
    modal_header = _("Volume Transfer")
    submit_url = "horizon:virtual:volumes:volumes:show_transfer"
...
class UpdateView(forms.ModalFormView):
    form_class = virtual_forms.UpdateForm
    modal_header = _("Edit Volume")
    modal_id = "update_volume_modal"
    template_name = 'virtual/volumes/volumes/update.html'
    submit_url = "horizon:virtual:volumes:volumes:update"
    success_url = reverse_lazy("horizon:virtual:volumes:index")
    ...
    def get_object(self):
        if not hasattr(self, "_object"):
            ...
            try:
                ...
                url = reverse('horizon:virtual:volumes:index')
...
class EditAttachmentsView(tables.DataTableView, forms.ModalFormView):
    table_class = virtual_tables.AttachmentsTable
    form_class = virtual_forms.AttachForm
    form_id = "attach_volume_form"
    modal_header = _("Manage Volume Attachments")
    modal_id = "attach_volume_modal"
    template_name = 'virtual/volumes/volumes/attach.html'
    submit_url = "horizon:virtual:volumes:volumes:attach"
    success_url = reverse_lazy("horizon:virtual:volumes:index")
...
class RetypeView(forms.ModalFormView):
    form_class = virtual_forms.RetypeForm
    modal_id = "retype_volume_modal"
    modal_header = _("Change Volume Type")
    template_name = 'virtual/volumes/volumes/retype.html'
    submit_label = _("Change Volume Type")
    submit_url = "horizon:virtual:volumes:volumes:retype"
    success_url = reverse_lazy("horizon:virtual:volumes:index")
...
class EncryptionDetailView(generic.TemplateView):
    template_name = 'virtual/volumes/volumes/encryption_detail.html'
