...
from openstack_dashboard.dashboards.virtual.volumes.backups \
...
class CreateBackupView(forms.ModalFormView):
    ...
    template_name = 'virtual/volumes/backups/create_backup.html'
    submit_label = _("Create Volume Backup")
    submit_url = "horizon:virtual:volumes:volumes:create_backup"
    success_url = reverse_lazy("horizon:virtual:volumes:backups_tab")
...
class RestoreBackupView(forms.ModalFormView):
    ...
    template_name = 'virtual/volumes/backups/restore_backup.html'
    submit_label = _("Restore Backup to Volume")
    submit_url = "horizon:virtual:volumes:backups:restore"
