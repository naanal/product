...
from openstack_dashboard.dashboards.virtual.volumes.volumes \
    import tables as volume_tables
from openstack_dashboard.test import helpers as test


INDEX_URL = reverse('horizon:virtual:volumes:index')
VOLUME_SNAPSHOTS_TAB_URL = urlunquote(reverse(
    'horizon:virtual:volumes:snapshots_tab'))
VOLUME_BACKUPS_TAB_URL = urlunquote(reverse(
    'horizon:virtual:volumes:backups_tab'))
...
class VolumeAndSnapshotsAndBackupsTests(test.TestCase):
    ...
    def test_snapshots_index_paginated(self):
        ...
        size = settings.API_RESULT_PAGE_SIZE
        base_url = reverse('horizon:virtual:volumes:snapshots_tab')
    ...
    def test_backups_index_paginated(self):
        ...
        size = settings.API_RESULT_PAGE_SIZE
        base_url = reverse('horizon:virtual:volumes:backups_tab')
