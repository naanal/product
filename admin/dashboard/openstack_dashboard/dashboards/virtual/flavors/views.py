...
from openstack_dashboard.dashboards.virtual.flavors \
    import tables as project_tables
from openstack_dashboard.dashboards.virtual.flavors \
    import workflows as flavor_workflows


INDEX_URL = "horizon:virtual:flavors:index"


class IndexView(tables.DataTableView):
    table_class = project_tables.FlavorsTable
    template_name = 'virtual/flavors/index.html'
...
class CreateView(workflows.WorkflowView):
    ...
    template_name = 'virtual/flavors/create.html'
    page_title = _("Create Flavor")


class UpdateView(workflows.WorkflowView):
    workflow_class = flavor_workflows.UpdateFlavor
    template_name = 'virtual/flavors/update.html'
