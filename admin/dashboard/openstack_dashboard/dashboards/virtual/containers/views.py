...
from openstack_dashboard.dashboards.virtual.containers \
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'virtual/containers/create.html'
...
class CreatePseudoFolderView(forms.ModalFormView):
    ...
    template_name = 'virtual/containers/create_pseudo_folder.html'
    success_url = "horizon:virtual:containers:index"
...
class UploadView(forms.ModalFormView):
    ...
    template_name = 'virtual/containers/upload.html'
    success_url = "horizon:virtual:containers:index"
...
def object_download(request, container_name, object_path):
    try:
        ...
        redirect = reverse("horizon:virtual:containers:index")
...
class CopyView(forms.ModalFormView):
    ...
    template_name = 'virtual/containers/copy.html'
    success_url = "horizon:virtual:containers:index"
...
class ContainerDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'virtual/containers/container_detail.html'
...
class ObjectDetailView(forms.ModalFormMixin, generic.TemplateView):
    template_name = 'virtual/containers/object_detail.html'
...
class UpdateObjectView(forms.ModalFormView):
    ...
    template_name = 'virtual/containers/update.html'
    success_url = "horizon:virtual:containers:index"
