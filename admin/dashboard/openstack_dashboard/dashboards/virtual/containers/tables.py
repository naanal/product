...
class ViewContainer(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:container_detail"
...
class MakePublicContainer(tables.Action):
    ...
    def single(self, table, request, obj_id):
        ...
        return shortcuts.redirect('horizon:virtual:containers:index')
...
class DeleteContainer(tables.DeleteAction):
    ...
    success_url = "horizon:virtual:containers:index"
...
class CreateContainer(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class ListObjects(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:index"
    icon = "list"
...
class CreatePseudoFolder(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:create_pseudo_folder"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UploadObject(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:object_upload"
    classes = ("ajax-modal",)
    icon = "upload"
...
def get_container_link(container):
    return reverse("horizon:virtual:containers:index",
...
def get_metadata(container):
    ...
    if not hasattr(container, 'is_public'):
        return template.loader.render_to_string(
            'virtual/containers/_container_loader.html'
        )
    template_name = 'virtual/containers/_container_metadata.html'
...
class ViewObject(tables.LinkAction):
    name = "view"
    verbose_name = _("View Details")
    url = "horizon:virtual:containers:object_detail"
    classes = ("ajax-modal", "btn-view")
...
class UpdateObject(tables.LinkAction):
    name = "update_object"
    verbose_name = _("Edit")
    url = "horizon:virtual:containers:object_update"
    classes = ("ajax-modal",)
    icon = "pencil"
    allowed_data_types = ("objects",)
...
class CopyObject(tables.LinkAction):
    name = "copy"
    verbose_name = _("Copy")
    url = "horizon:virtual:containers:object_copy"
    classes = ("ajax-modal",)
...
class DownloadObject(tables.LinkAction):
    ...
    url = "horizon:virtual:containers:object_download"
    icon = "download"
    allowed_data_types = ("objects",)
