...
from openstack_dashboard.dashboards.virtual.routers\
    import forms as virtual_forms
from openstack_dashboard.dashboards.virtual.routers import tables as rtables
from openstack_dashboard.dashboards.virtual.routers import tabs as rdtabs


class IndexView(tables.DataTableView):
    table_class = rtables.RoutersTable
    template_name = 'virtual/routers/index.html'
...
class DetailView(tabs.TabbedTableView):
    ...
    failure_url = reverse_lazy('horizon:virtual:routers:index')
    network_url = 'horizon:virtual:networks:detail'
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'virtual/routers/create.html'
    success_url = reverse_lazy("horizon:virtual:routers:index")
    page_title = _("Create Router")
    submit_label = _("Create Router")
    submit_url = reverse_lazy("horizon:virtual:routers:create")
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'virtual/routers/update.html'
    success_url = reverse_lazy("horizon:virtual:routers:index")
    page_title = _("Update Router")
    submit_label = _("Save Changes")
    submit_url = "horizon:virtual:routers:update"
