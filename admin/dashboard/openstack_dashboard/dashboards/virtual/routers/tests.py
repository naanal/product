...
class RouterActionTests(RouterMixin, test.TestCase):
    ...
    def test_router_update_get_dvr_disabled(self):
        ...
        self.assertTemplateUsed(res, 'virtual/routers/update.html')
...
class RouterViewTests(RouterMixin, test.TestCase):
    ...
    def test_create_button_disabled_when_quota_exceeded(self):
        ...
        res = self.client.get(self.INDEX_URL)
        self.assertTemplateUsed(res, 'virtual/routers/index.html')
    ...
    def test_create_button_attributes(self):
        ...
        self.assertEqual('horizon:virtual:routers:create', create_action.url)
