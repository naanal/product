...
from openstack_dashboard.dashboards.virtual.images import utils
from openstack_dashboard.test import helpers as test


INDEX_URL = reverse('horizon:virtual:images:index')
CREATE_URL = reverse('horizon:virtual:images:images:create')
...
class ImagesAndSnapshotsTests(test.TestCase):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'virtual/images/index.html')
