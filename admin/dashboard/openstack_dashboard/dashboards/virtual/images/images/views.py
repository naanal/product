...
class CreateView(forms.ModalFormView):
    ...
    submit_url = reverse_lazy('horizon:virtual:images:images:create')
    template_name = 'virtual/images/images/create.html'
    context_object_name = 'image'
    success_url = reverse_lazy("horizon:virtual:images:index")
...
class UpdateView(forms.ModalFormView):
    ...
    submit_url = "horizon:virtual:images:images:update"
    template_name = 'virtual/images/images/update.html'
    success_url = reverse_lazy("horizon:virtual:images:index")
    ...
    def get_object(self):
        try:
            ...
            url = reverse('horizon:virtual:images:index')
...
class DetailView(tabs.TabView):
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:virtual:images:index')
