...
from openstack_dashboard.dashboards.virtual.images.images import forms
from openstack_dashboard.dashboards.virtual.images.images import tables


IMAGES_INDEX_URL = reverse('horizon:virtual:images:index')
...
class UpdateImageFormTests(test.TestCase):
    ...
    def test_image_update(self):
        ...
        url = reverse('horizon:virtual:images:images:update',
                      args=[image.id])
...
class ImageViewTests(test.TestCase):
    ...
    def test_image_create_get(self):
        ...
        url = reverse('horizon:virtual:images:images:create')
        res = self.client.get(url)
        self.assertTemplateUsed(res,
                                'virtual/images/images/create.html')
    ...
    def test_image_detail_get(self):
        ...
        res = self.client.get(reverse('horizon:virtual:images:images:detail',
                                      args=[image.id]))
    ...
    def test_protected_image_detail_get(self):
        ...
        res = self.client.get(
            reverse('horizon:virtual:images:images:detail',
                    args=[image.id]))
        self.assertTemplateUsed(res,
                                'horizon/common/_detail.html')
        self.assertEqual(res.context['image'].protected, image.protected)
    ...
    def test_image_detail_get_with_exception(self):
        ...
        url = reverse('horizon:virtual:images:images:detail',
                      args=[image.id])
        res = self.client.get(url)
    ...
    def test_image_update_get(self):
        ...
        res = self.client.get(
            reverse('horizon:virtual:images:images:update',
                    args=[image.id]))

        self.assertTemplateUsed(res,
                                'virtual/images/images/_update.html')
        self.assertEqual(res.context['image'].name, image.name)
