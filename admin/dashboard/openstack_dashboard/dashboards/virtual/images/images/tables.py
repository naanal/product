...
class LaunchImageNG(LaunchImage):
    ...
    url = "horizon:virtual:images:index"
    classes = ("btn-launch", )
    ajax = False
...
class CreateImage(tables.LinkAction):
    ...
    url = "horizon:virtual:images:images:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditImage(tables.LinkAction):
    ...
    url = "horizon:virtual:images:images:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class ImagesTable(tables.DataTable):
    ...
    name = tables.Column(get_image_name,
                         link="horizon:virtual:images:images:detail",
                         truncate=40,
