...
from openstack_dashboard.dashboards.virtual.access_and_security.\
    floating_ips import forms as virtual_forms
from openstack_dashboard.dashboards.virtual.access_and_security.\
    floating_ips import workflows as virtual_workflows


class AssociateView(workflows.WorkflowView):
    workflow_class = virtual_workflows.IPAssociationWorkflow


class AllocateView(forms.ModalFormView):
    form_class = virtual_forms.FloatingIpAllocate
    form_id = "associate_floating_ip_form"
    modal_header = _("Allocate Floating IP")
    template_name = 'virtual/access_and_security/floating_ips/allocate.html'
    submit_label = _("Allocate IP")
    submit_url = reverse_lazy(
        "horizon:virtual:access_and_security:floating_ips:allocate")
