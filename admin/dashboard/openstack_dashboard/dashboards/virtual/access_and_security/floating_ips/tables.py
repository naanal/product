...
class AllocateIP(tables.LinkAction):
    ...
    classes = ("ajax-modal",)
    icon = "link"
    url = "horizon:virtual:access_and_security:floating_ips:allocate"

    def single(self, data_table, request, *args):
        return shortcuts.redirect('horizon:virtual:access_and_security:index')
...
def get_instance_link(datum):
    if datum.instance_type == 'compute':
        return reverse("horizon:virtual:instances:detail",
