...
class AccessAndSecurityTests(test.TestCase):
    ...
    def _test_index(self, ec2_enabled=True, instanceless_ips=False):
        ...
        self.assertTemplateUsed(res, 'virtual/access_and_security/index.html')
    ...
    def test_association(self):
        ...
        res = self.client.get(reverse("horizon:virtual:access_and_security:"
...
class SecurityGroupTabTests(test.TestCase):
    ...
    def test_create_button_attributes(self):
        ...
        url = 'horizon:virtual:access_and_security:security_groups:create'
