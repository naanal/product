...
from openstack_dashboard.dashboards.virtual.access_and_security.keypairs \
    import forms as virtual_forms


class CreateView(forms.ModalFormView):
    form_class = virtual_forms.CreateKeypair
    form_id = "create_keypair_form"
    modal_header = _("Create Key Pair")
    template_name = 'virtual/access_and_security/keypairs/create.html'
    submit_label = _("Create Key Pair")
    submit_url = reverse_lazy(
        "horizon:virtual:access_and_security:keypairs:create")
    success_url = 'horizon:virtual:access_and_security:keypairs:download'
    page_title = _("Create Key Pair")
    cancel_url = reverse_lazy(
        "horizon:virtual:access_and_security:index")
...
class ImportView(forms.ModalFormView):
    form_class = virtual_forms.ImportKeypair
    form_id = "import_keypair_form"
    modal_header = _("Import Key Pair")
    template_name = 'virtual/access_and_security/keypairs/import.html'
    submit_label = _("Import Key Pair")
    submit_url = reverse_lazy(
        "horizon:virtual:access_and_security:keypairs:import")
...
class DetailView(views.HorizonTemplateView):
    template_name = 'virtual/access_and_security/keypairs/detail.html'
...
class DownloadView(views.HorizonTemplateView):
    template_name = 'virtual/access_and_security/keypairs/download.html'
