...
class DownloadEC2(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:virtual:access_and_security:api_access:ec2"
...
class DownloadOpenRC(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:virtual:access_and_security:api_access:openrc"
...
class DownloadOpenRCv2(tables.LinkAction):
    ...
    icon = "download"
    url = "horizon:virtual:access_and_security:api_access:openrcv2"
...
class ViewCredentials(tables.LinkAction):
    ...
    classes = ("ajax-modal", )
    icon = "plus"
    url = "horizon:virtual:access_and_security:api_access:view_credentials"
    ...
    def allowed(self, request, datum=None):
        try:
            ...
            if (api.base.is_service_enabled(request, 'ec2') and
                virtual_forms.get_ec2_credentials(request) and
