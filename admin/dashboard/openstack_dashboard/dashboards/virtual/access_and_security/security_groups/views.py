...
from openstack_dashboard.dashboards.virtual.access_and_security.\
    security_groups import forms as virtual_forms
from openstack_dashboard.dashboards.virtual.access_and_security.\
    security_groups import tables as virtual_tables


class DetailView(tables.DataTableView):
    table_class = virtual_tables.RulesTable
    template_name = 'virtual/access_and_security/security_groups/detail.html'
...
class UpdateView(forms.ModalFormView):
    form_class = virtual_forms.UpdateGroup
    form_id = "update_security_group_form"
    modal_header = _("Edit Security Group")
    modal_id = "update_security_group_modal"
    template_name = 'virtual/access_and_security/security_groups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:virtual:access_and_security:security_groups:update"
    success_url = reverse_lazy('horizon:virtual:access_and_security:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('horizon:virtual:access_and_security:index')
...
class AddRuleView(forms.ModalFormView):
    form_class = virtual_forms.AddRule
    form_id = "create_security_group_rule_form"
    modal_header = _("Add Rule")
    modal_id = "create_security_group_rule_modal"
    template_name = 'virtual/access_and_security/security_groups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:virtual:access_and_security:security_groups:add_rule"
    url = "horizon:virtual:access_and_security:security_groups:detail"
...
class CreateView(forms.ModalFormView):
    form_class = virtual_forms.CreateGroup
    form_id = "create_security_group_form"
    modal_header = _("Create Security Group")
    modal_id = "create_security_group_modal"
    template_name = 'virtual/access_and_security/security_groups/create.html'
    submit_label = _("Create Security Group")
    submit_url = reverse_lazy(
        "horizon:virtual:access_and_security:security_groups:create")
    success_url = reverse_lazy('horizon:virtual:access_and_security:index')
