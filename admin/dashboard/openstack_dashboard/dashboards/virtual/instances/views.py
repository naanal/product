...
class IndexView(tables.DataTableView):
    ...
    template_name = 'virtual/instances/index.html'
...
def vnc(request, instance_id):
    try:
        ...
        redirect = reverse("horizon:virtual:instances:index")
...
class SerialConsoleView(generic.TemplateView):
    template_name = 'virtual/instances/serial_console.html'
...
class UpdateView(workflows.WorkflowView):
    ...
    success_url = reverse_lazy("horizon:virtual:instances:index")
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'virtual/instances/rebuild.html'
    success_url = reverse_lazy('horizon:virtual:instances:index')
...
class DecryptPasswordView(forms.ModalFormView):
    ...
    template_name = 'virtual/instances/decryptpassword.html'
    success_url = reverse_lazy('horizon:virtual:instances:index')
...
class DetailView(tabs.TabView):
    ...
    redirect_url = 'horizon:virtual:instances:index'
    page_title = "{{ instance.name|default:instance.id }}"
    image_url = 'horizon:virtual:images:images:detail'
    volume_url = 'horizon:virtual:volumes:volumes:detail'
...
class AttachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'virtual/instances/attach_interface.html'
    modal_header = _("Attach Interface")
    form_id = "attach_interface_form"
    submit_label = _("Attach Interface")
    submit_url = "horizon:virtual:instances:attach_interface"
    success_url = reverse_lazy('horizon:virtual:instances:index')
...
class DetachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'virtual/instances/detach_interface.html'
    modal_header = _("Detach Interface")
    form_id = "detach_interface_form"
    submit_label = _("Detach Interface")
    submit_url = "horizon:virtual:instances:detach_interface"
    success_url = reverse_lazy('horizon:virtual:instances:index')
