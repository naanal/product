...
from openstack_dashboard.dashboards.virtual.instances import console
from openstack_dashboard.dashboards.virtual.instances import tables
from openstack_dashboard.dashboards.virtual.instances import tabs
from openstack_dashboard.dashboards.virtual.instances import workflows
from openstack_dashboard.test import helpers
from openstack_dashboard.usage import quotas


INDEX_URL = reverse('horizon:virtual:instances:index')
...
class InstanceTests(helpers.TestCase):
    ...
    def test_index_server_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'virtual/instances/index.html')
    ...
    def _get_instance_details(self, server, qs=None,
        ...
        url = reverse('horizon:virtual:instances:detail', args=[server.id])
        if qs:
            url += qs
    ...
    def test_instance_details_console_tab(self):
        ...
        self.assertTemplateUsed(res,
                                'virtual/instances/_detail_console.html')
    ...
    def test_instance_details_exception(self):
        ...
        url = reverse('horizon:virtual:instances:detail',
                      args=[server.id])
    ...
    def test_instance_details_flavor_not_found(self):
        ...
        self.assertTemplateUsed(res,
                                'virtual/instances/_detail_overview.html')
    ...
    def test_instance_log(self):
        ...
        url = reverse('horizon:virtual:instances:console',
                      args=[server.id])
        tg = tabs.InstanceDetailTabs(self.request, instance=server)
    ...
    def test_instance_vnc(self):
        ...
        url = reverse('horizon:virtual:instances:vnc',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_spice(self):
        ...
        url = reverse('horizon:virtual:instances:spice',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_instance_rdp(self):
        ...
        url = reverse('horizon:virtual:instances:rdp',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_create_instance_snapshot(self):
        ...
        formData = {'instance_id': server.id,
                    ...
                    'name': 'snapshot1'}
        url = reverse('horizon:virtual:images:snapshots:create',
                      args=[server.id])
        redir_url = reverse('horizon:virtual:images:index')
    ...
    def _test_instances_index_retrieve_password_action(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:virtual:instances:index')
        res = self.client.get(url)
        for server in servers:
    ...
    def test_decrypt_instance_password(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:virtual:instances:decryptpassword',
                      args=[server.id,
                            server.key_name])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'virtual/instances/decryptpassword.html')
    ...
    def test_instance_update_get(self):
        ...
        url = reverse('horizon:virtual:instances:update', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_update_get_server_get_exception(self):
        ...
        url = reverse('horizon:virtual:instances:update',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_launch_instance_get(self,
        ...
        url = reverse('horizon:virtual:instances:launch')
    ...
    def test_instance_resize_get(self):
        ...
        url = reverse('horizon:virtual:instances:resize', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_resize_get_server_get_exception(self):
        ...
        url = reverse('horizon:virtual:instances:resize',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_rebuild_instance_get(self, expect_password_fields=True):
        ...
        url = reverse('horizon:virtual:instances:rebuild', args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'virtual/instances/rebuild.html')
    ...
    def _instance_rebuild_post(self, server_id, image_id,
        ...
        url = reverse('horizon:virtual:instances:rebuild',
                      args=[server_id])
    ...
    def test_index_form_action_with_pagination(self):
        ...
        next_page_url = "?".join([reverse('horizon:virtual:instances:index'),
                                  params])
...
class ConsoleManagerTests(helpers.TestCase):
    ...
    def test_interface_attach_get(self):
        ...
        url = reverse('horizon:virtual:instances:attach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'virtual/instances/attach_interface.html')
    ...
    def test_interface_detach_get(self):
        ...
        url = reverse('horizon:virtual:instances:detach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'virtual/instances/detach_interface.html')
