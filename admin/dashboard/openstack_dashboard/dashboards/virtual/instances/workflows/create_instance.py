...
from openstack_dashboard.dashboards.virtual.images \
...
class SetInstanceDetailsAction(workflows.Action):
    ...
    class Meta(object):
        name = _("Details")
        help_text_template = ("virtual/instances/"
...
KEYPAIR_IMPORT_URL = "horizon:virtual:access_and_security:keypairs:import"
...
class SetNetwork(workflows.Step):
    ...
    if api.neutron.is_port_profiles_supported():
        ...
        template_name = "virtual/instances/_update_networks.html"
...
class LaunchInstance(workflows.Workflow):
    ...
    success_url = "horizon:virtual:instances:index"
    multipart = True
