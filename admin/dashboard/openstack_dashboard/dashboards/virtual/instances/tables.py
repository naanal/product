...
from openstack_dashboard.dashboards.virtual.access_and_security.floating_ips \
    import workflows
...
class EditInstance(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:instances:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateSnapshot(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:images:snapshots:create"
    classes = ("ajax-modal",)
    icon = "camera"
...
class ConsoleLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:instances:detail"
    classes = ("btn-console",)
...
class ResizeLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:instances:resize"
...
class RebuildInstance(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:instances:rebuild"
...
class DecryptInstancePassword(tables.LinkAction):
    ...
    url = "horizon:virtual:instances:decryptpassword"
...
class AssociateIP(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:access_and_security:floating_ips:associate"
    classes = ("ajax-modal",)
    icon = "link"
...
class AttachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:virtual:instances:attach_interface"
...
class DetachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    classes = ("btn-confirm", "ajax-modal")
    url = "horizon:virtual:instances:detach_interface"
...
def get_ips(instance):
    template_name = 'virtual/instances/_instance_ips.html'
    ip_groups = {}
...
def get_size(instance):
    if hasattr(instance, "full_flavor"):
        template_name = 'virtual/instances/_instance_flavor.html'
