...
class CreateNetwork(tables.LinkAction):
    ...
    url = "horizon:virtual:networks:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class EditNetwork(policy.PolicyTargetMixin, CheckNetworkEditable,
    ...
    url = "horizon:virtual:networks:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateSubnet(policy.PolicyTargetMixin, CheckNetworkEditable,
    ...
    url = "horizon:virtual:networks:addsubnet"
    classes = ("ajax-modal",)
    icon = "plus"
...
def get_subnets(network):
    template_name = 'virtual/networks/_network_ips.html'
...
class NetworksTable(tables.DataTable):
    name = tables.Column("name_or_id",
                         verbose_name=_("Name"),
                         link='horizon:virtual:networks:detail')
