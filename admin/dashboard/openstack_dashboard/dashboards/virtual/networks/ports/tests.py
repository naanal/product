...
DETAIL_URL = 'horizon:virtual:networks:ports:detail'

NETWORKS_INDEX_URL = reverse('horizon:virtual:networks:index')
NETWORKS_DETAIL_URL = 'horizon:virtual:networks:detail'
...
class NetworkPortTests(test.TestCase):
    ...
    def _test_port_update_get(self, mac_learning=False, binding=False):
        ...
        url = reverse('horizon:virtual:networks:editport',
                      args=[port.network_id, port.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'virtual/networks/ports/update.html')
