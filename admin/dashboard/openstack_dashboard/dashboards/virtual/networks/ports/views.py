...
from openstack_dashboard.dashboards.virtual.networks.ports \
    import tables as virtual_tables
from openstack_dashboard.dashboards.virtual.networks.ports \
    import tabs as virtual_tabs

STATE_DICT = dict(virtual_tables.DISPLAY_CHOICES)
STATUS_DICT = dict(virtual_tables.STATUS_DISPLAY_CHOICES)
VNIC_TYPES = dict(virtual_forms.VNIC_TYPES)


class DetailView(tabs.TabView):
    tab_group_class = virtual_tabs.PortDetailTabs
    ...
    def get_context_data(self, **kwargs):
        ...
        subnet_url = "horizon:virtual:networks:subnets:detail"
        ...
        table = virtual_tables.PortsTable(self.request,
    ...
    def get_redirect_url():
        return reverse('horizon:virtual:networks:index')


class UpdateView(forms.ModalFormView):
    form_class = virtual_forms.UpdatePort
    form_id = "update_port_form"
    modal_header = _("Edit Port")
    template_name = 'virtual/networks/ports/update.html'
    context_object_name = 'port'
    submit_label = _("Save Changes")
    submit_url = "horizon:virtual:networks:editport"
    success_url = 'horizon:virtual:networks:detail'
