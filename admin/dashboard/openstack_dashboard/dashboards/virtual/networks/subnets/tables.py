...
class DeleteSubnet(SubnetPolicyTargetMixin, CheckNetworkEditable,
    ...
    def delete(self, request, obj_id):
        try:
            ...
            redirect = reverse('horizon:virtual:networks:detail',
                               args=[network_id])
...
class UpdateSubnet(SubnetPolicyTargetMixin, CheckNetworkEditable,
    ...
    url = "horizon:virtual:networks:editsubnet"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class SubnetsTable(tables.DataTable):
    name = tables.Column("name_or_id", verbose_name=_("Name"),
                         link='horizon:virtual:networks:subnets:detail')
    ...
    failure_url = reverse_lazy('horizon:virtual:networks:index')
