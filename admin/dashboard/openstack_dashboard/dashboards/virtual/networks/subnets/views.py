...
from openstack_dashboard.dashboards.virtual.networks.subnets import utils
from openstack_dashboard.dashboards.virtual.networks.subnets \
    import workflows as virtual_workflows


class CreateView(workflows.WorkflowView):
    workflow_class = virtual_workflows.CreateSubnet
    ...
    def get_object(self):
        try:
            ...
            redirect = reverse('horizon:virtual:networks:index')
...
class UpdateView(workflows.WorkflowView):
    workflow_class = virtual_workflows.UpdateSubnet
...
class DetailView(tabs.TabView):
    tab_group_class = virtual_tabs.SubnetDetailTabs
    ...
    def get_context_data(self, **kwargs):
        ...
        table = virtual_tables.SubnetsTable(self.request,
    ...
    def get_network_detail_url(network_id):
        return reverse('horizon:virtual:networks:detail',
                       args=(network_id,))
