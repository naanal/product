...
from openstack_dashboard.dashboards.virtual.networks import tables\
    as networks_tables
from openstack_dashboard.dashboards.virtual.networks import workflows
from openstack_dashboard.test import helpers as test
from openstack_dashboard.usage import quotas


INDEX_URL = reverse('horizon:virtual:networks:index')
...
class NetworkTests(test.TestCase, NetworkStubMixin):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'virtual/networks/index.html')
    ...
    def _test_network_detail(self, mac_learning=False):
        ...
        res = self.client.get(reverse('horizon:virtual:networks:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'virtual/networks/detail.html')
    ...
    def _test_network_detail_network_exception(self, mac_learning=False):
        ...
        url = reverse('horizon:virtual:networks:detail', args=[network_id])
    ...
    def test_network_create_get(self,
        ...
        url = reverse('horizon:virtual:networks:create')
        res = self.client.get(url)
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:virtual:networks:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'virtual/networks/update.html')
...
class NetworkViewTests(test.TestCase, NetworkStubMixin):
    ...
    def test_create_button_attributes(self):
        ...
        self.assertEqual('horizon:virtual:networks:create', create_action.url)
    ...
    def test_create_subnet_button_attributes(self):
        ...
        self.assertEqual(set(['ajax-modal']), set(create_action.classes))
        self.assertEqual('horizon:virtual:networks:addsubnet',
                         create_action.url)
