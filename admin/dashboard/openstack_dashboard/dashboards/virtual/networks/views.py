...
from openstack_dashboard.dashboards.virtual.networks \
    import forms as networks_forms
...
from openstack_dashboard.dashboards.virtual.networks \
    import workflows as networks_workflows


class IndexView(tables.DataTableView):
    table_class = networks_tables.NetworksTable
    template_name = 'virtual/networks/index.html'
...
class CreateView(workflows.WorkflowView):
    workflow_class = networks_workflows.CreateNetwork


class UpdateView(forms.ModalFormView):
    context_object_name = 'network'
    form_class = networks_forms.UpdateNetwork
    form_id = "update_network_form"
    modal_header = _("Edit Network")
    submit_label = _("Save Changes")
    submit_url = "horizon:virtual:networks:update"
    success_url = reverse_lazy("horizon:virtual:networks:index")
    template_name = 'virtual/networks/update.html'
...
class DetailView(tables.MultiTableView):
    ...
    template_name = 'virtual/networks/detail.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        choices = networks_tables.STATUS_DISPLAY_CHOICES
    ...
    def get_redirect_url():
        return reverse_lazy('horizon:virtual:networks:index')
